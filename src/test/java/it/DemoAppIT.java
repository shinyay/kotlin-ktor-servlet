...
public class DemoAppIT {
    ...
    public void testFeatureC() throws Exception {
        driver.get(baseUrl + contextroot + "/");
        try {
            assertEquals("Sample application with HTML builder", driver.findElement(By.xpath("//h1[1]"))
                    .getText());
        } catch (Error e) {
    ...
    public void testHelloWorld() throws Exception {
        driver.get(baseUrl + contextroot + "/");
        try {
            assertEquals("Hello World!", driver.findElement(By.xpath("//h2[position()=1]"))
                    .getText());
        } catch (Error e) {
            verificationErrors.append(e.toString());
        }
